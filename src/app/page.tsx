      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl leading-relaxed text-gray-400 mb-12">
            Store your recipes, plan meals, and generate shopping lists. Import
            from recipe links or add manually. Simple and organized.
          </p>
    ...
    <section className="py-24 bg-gray-950/50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="bg-gray-900/50 border-gray-800/50 hover:border-red-600/30 transition-all duration-300 rounded-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                Paste a recipe URL to automatically import ingredients,
          ...
          <Card className="bg-gray-900/50 border-gray-800/50 hover:border-red-600/30 transition-all duration-300 rounded-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                Search and filter your recipes by ingredients, categories, or
                cooking time.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900/50 border-gray-800/50 hover:border-red-600/30 transition-all duration-300 rounded-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                Plan your week with a meal planner and generate shopping lists
                automatically.
              </p>
            </CardContent>
          </Card>
